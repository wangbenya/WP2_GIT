...
for (tt in c(1:30)){
  ...
  dat.fit1 <- fit.variogram(var.smpl1,fit.sills = F,fit.kappa = F,vgm(model="Sph",range = 3000,psill = 0.12,nugget = 0.05))
  ...
  plot(kriging_DON_m1)
  range(kriging_DON_m1$var1.pred)
...
for (a1 in c(0.5,0.6,0.8,1.0)){
  for (a2 in c(1.0,1.2,1.5,2.0,2.5)){
    if (a2-a1>=0.5){
