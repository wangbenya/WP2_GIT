...
all_points[all_points$DON==0.25,"DON"]=0.5
...
para_rf = makeParamSet(
  ...
  makeIntegerParam("nodesize", lower = 65, upper = 75),
...
for (tt in c(1:10)){
  ...
  trainIndex <- createDataPartition(all_points$DON, p = 0.7, list = FALSE)  
...
#  M2_test$DON<-log10(M2_test$DON)
  ...
  set.seed(seeds)
  WP2Train<-M2_train[,-c(1:4,6,7,10)]
  WP2Test<-M2_test[,-c(1:4,6,7,10)]
