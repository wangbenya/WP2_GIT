...
## build the model for DON map2
for (t in seq(1,6)){
  WP2Train[, t][WP2Train[, t] <=0.6] <- "Low"
  WP2Train[, t][WP2Train[, t] < 1.2] <- "Medium"
  WP2Train[, t][(WP2Train[, t] != "Low") & (WP2Train[, t] != "Medium")] <- "High"
  WP2Train[, t] <- factor(WP2Train[, t], levels = c("Low", "Medium", "High"))
  
}

for (t in seq(1,6)){
  WP2Test[, t][WP2Test[, t] <=0.6] <- "Low"
  WP2Test[, t][WP2Test[, t] < 1.2] <- "Medium"
  WP2Test[, t][(WP2Test[, t] != "Low") & (WP2Test[, t] != "Medium")] <- "High"
  WP2Test[, t] <- factor(WP2Test[, t], levels = c("Low", "Medium", "High"))
...
M4_train_withKN <- cbind(base6[, c(12, 10, 8, 6, 4,2, 13:17)],m22=m22$data$response,as.data.frame(landscape_train_withKN))
M4_test_withKN <- cbind(test6[, c(12, 10, 8, 6, 4,2, 13:17)],map2_predict$data$response,as.data.frame(landscape_test_withKN))
...
M4_train_withKN<-M4_train_withKN[,-4]
M4_test_withKN<-M4_test_withKN[,-4]

for (t in seq(1,5)){
  M4_train_withKN[, t][M4_train_withKN[, t] <=0.6] <- "Low"
  M4_train_withKN[, t][M4_train_withKN[, t] < 1.2] <- "Medium"
  M4_train_withKN[, t][(M4_train_withKN[, t] != "Low") & (M4_train_withKN[, t] != "Medium")] <- "High"
  M4_train_withKN[, t] <- factor(M4_train_withKN[, t], levels = c("Low", "Medium", "High"))
  
}

for (t in seq(1,5)){
  M4_test_withKN[, t][M4_test_withKN[, t] <=0.6] <- "Low"
  M4_test_withKN[, t][M4_test_withKN[, t] < 1.2] <- "Medium"
  M4_test_withKN[, t][(M4_test_withKN[, t] != "Low") & (M4_test_withKN[, t] != "Medium")] <- "High"
  M4_test_withKN[, t] <- factor(M4_test_withKN[, t], levels = c("Low", "Medium", "High"))
